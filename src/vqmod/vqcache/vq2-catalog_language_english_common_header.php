...
$_['text_welcome']        = 'Welcome visitor you can <a href="%s">login</a> or <a href="%s">sign up</a>.';
$_['text_logged']         = 'You are logged in as <a href="%s">%s</a> <b>(</b> <a href="%s">Logout</a> <b>)</b>';
$_['text_account']        = 'My Account';
$_['text_checkout']       = 'Checkout';
 $_['text_welcome']  = '<li class="login_h"><a href="%s"><i class="icon-lock"></i>Login</a></li> <li><a href="%s"><i class="icon-file-alt"></i>Sign Up</a></li>  ';
