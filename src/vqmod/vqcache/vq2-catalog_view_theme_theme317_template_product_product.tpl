...
<div class="<?php if ($column_left or $column_right) { ?>span9<?php } ?> <?php if ($column_left and $column_right) { ?>span6<?php } ?> <?php if (!$column_right and !$column_left) { ?>span12 <?php } ?>" id="content"><?php echo $content_top; ?>
	...
	<?php } ?>
		...
		<div id="default_gallery" class="left spacing">
			<?php if (!empty($thumb1)) { ?>
			<div class="zoom-top">
				<a href="<?php echo $thumb1; ?>" title="<?php echo $heading_title; ?>"  data-gal="prettyPhoto[gallery1]" >
			...
			<?php if ($images) { ?>
				<div class="image-additional">
					<ul id="image-additional">
						<?php if (!empty($thumb1)) { ?>
						<li>
							<a href="<?php echo $thumb1; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo $thumb1; ?>' "><img src="<?php echo $thumb1; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
						</li>
						<?php } ?>
						<?php foreach ($images as $image) { ?>
...
<!--BOF Product Color Option-->
			...
			<div rel="<?php echo $option['option_id']; ?>" id="option-<?php echo $option['product_option_id']; ?>" class="option">
			  ...
			  <?php foreach ($option['option_value'] as $option_value) { ?>
				<a class="color-option <?php echo $pco_color_selector_style; ?>"				
				...
				title="<?php echo $option_value['name']; ?> <?php if ($option_value['price']) { ?>(<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)<?php } ?>"></a>
			  <?php } ?>
	  ...
	  <div class="cart">
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme317/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
	...
	<div class="box-product"> 
		<ul class="related-slider">
			...
			<?php if ($product['rating']) { ?>
				<img height="13" src="catalog/view/theme/theme317/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
			<?php } ?>
			</div>
			</li>
			<?php } ?>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme317/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme317/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
