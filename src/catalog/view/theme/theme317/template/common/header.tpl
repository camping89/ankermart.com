...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-116118357-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-116118357-1');
</script>

<!-- End Google Analytics -->

<!- Begin ShareThis ->
<script type="text/javascript">var switchTo5x=true;</script> <script type="text/javascript" src="https://ws.sharethis.com/button/buttons.js"></script> <script type="text/javascript">stLight.options({publisher: "fcdf6566-029f-4ca2-9970-161131afec88", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
<!- End ShareThis ->

<!-- Begin Userreport Survey -->
<!-- End Userreport Survey -->
...
<div class="container">
<?php if (!empty($error)) { ?>
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme317/image/close-1.png" alt="" class="close" /></div>
<?php } ?>
