		...
		<ul class="row">
		  ...
		  <?php 
			...
			<li class="<?php echo $a. $last_line ;?> span<?php echo $spanLine ;?>">
				...
				<?php if ($product['special']) { ?><div class="spec"><?php echo $text_spec; ?></div><?php } ?>
				<div class="image2">
					...
					<div  class="quick-view<?php echo $i;?> preview">
						<div class="wrapper marg row-fluid">
							...
							<div class="right span8">
								...
								<div class="clear"></div>
								<div class="rating">
									<img height="18" src="catalog/view/theme/theme317/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
								</div>
							</div>
						</div>
