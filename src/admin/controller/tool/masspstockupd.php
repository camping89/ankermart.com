<?php 
class ControllerToolmasspstockupd extends Controller { 
	private $error = array();
	...
	public function index() {
		...
		$this->data['masstxt_p_updates_quantity'] = $this->language->get('masstxt_p_updates_quantity');
		$this->data['masstxt_p_updates_value'] = $this->language->get('masstxt_p_updates_value');
		$this->data['masstxt_no_update_quantity_help'] = $this->language->get('masstxt_no_update_quantity_help');
		$this->data['masstxt_p_updates_minimum_quantity'] = $this->language->get('masstxt_p_updates_minimum_quantity');
		$this->data['masstxt_minimum_new_value'] = $this->language->get('masstxt_minimum_new_value');
		$this->data['masstxt_no_update_minimum_quantity_help'] = $this->language->get('masstxt_no_update_minimum_quantity_help');
		$this->data['masstxt_p_updates_subtract_stock'] = $this->language->get('masstxt_p_updates_subtract_stock');
		$this->data['masstxt_no_update_subtract_stock_help'] = $this->language->get('masstxt_no_update_subtract_stock_help');
		$this->data['masstxt_p_updates_out_of_stock_status'] = $this->language->get('masstxt_p_updates_out_of_stock_status');
		$this->data['masstxt_no_update_out_of_stock_status_help'] = $this->language->get('masstxt_no_update_out_of_stock_status_help');
		$this->data['masstxt_p_updates_requires_shipping'] = $this->language->get('masstxt_p_updates_requires_shipping');
		$this->data['masstxt_no_update_requires_shipping_help'] = $this->language->get('masstxt_no_update_requires_shipping_help');
		$this->data['masstxt_p_updates_date_available'] = $this->language->get('masstxt_p_updates_date_available');
		$this->data['masstxt_no_update_date_a_help'] = $this->language->get('masstxt_no_update_date_a_help');
		$this->data['masstxt_p_updates_status'] = $this->language->get('masstxt_p_updates_status');
		$this->data['masstxt_no_update_status_help'] = $this->language->get('masstxt_no_update_status_help');

		$this->data['masstxt_upd_quantity_addition_help'] = $this->language->get('masstxt_upd_quantity_addition_help');
		$this->data['masstxt_upd_quantity_subtraction_help'] = $this->language->get('masstxt_upd_quantity_subtraction_help');
		$this->data['masstxt_upd_quantity_multiplication_help'] = $this->language->get('masstxt_upd_quantity_multiplication_help');
		$this->data['masstxt_upd_quantity_replacement_help'] = $this->language->get('masstxt_upd_quantity_replacement_help');
		...
		if (isset($this->request->post['quantity_upd'])) {
      			$this->data['quantity_upd'] = $this->request->post['quantity_upd'];
		} else {
      			$this->data['quantity_upd'] = '';
    		}

		if (isset($this->request->post['minimum_upd'])) {
      			$this->data['minimum_upd'] = $this->request->post['minimum_upd'];
		} else {
      			$this->data['minimum_upd'] = '';
    		}

		if (isset($this->request->post['subtract_upd'])) {
      			$this->data['subtract_upd'] = $this->request->post['subtract_upd'];
		} else {
      			$this->data['subtract_upd'] = 'no-update';
    		}

		if (isset($this->request->post['stock_status_id_upd'])) {
      			$this->data['stock_status_id_upd'] = $this->request->post['stock_status_id_upd'];
		} else {
      			$this->data['stock_status_id_upd'] = 'no-update';
    		}

		if (isset($this->request->post['shipping_upd'])) {
      			$this->data['shipping_upd'] = $this->request->post['shipping_upd'];
		} else {
      			$this->data['shipping_upd'] = 'no-update';
    		}

		if (isset($this->request->post['date_av_upd'])) {
      			$this->data['date_av_upd'] = $this->request->post['date_av_upd'];
		} else {
      			$this->data['date_av_upd'] = '';
    		}

		if (isset($this->request->post['status_upd'])) {
      			$this->data['status_upd'] = $this->request->post['status_upd'];
		} else {
      			$this->data['status_upd'] = 'no-update';
    		}
...
if ($this->user->hasPermission('modify', 'tool/masspstockupd')) { /// modify permision
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		'href'      => $this->url->link('tool/masspstockupd', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->link('tool/masspstockupd', 'token=' . $this->session->data['token'], 'SSL');

		$this->template = 'tool/masspstockupd.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
