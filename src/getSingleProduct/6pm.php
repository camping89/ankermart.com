...
function processSpecImages($spec){
        ...
        foreach ($image as $index => $value) {
			...
			if($img_res){
				...
				$image_new_path = "../image/data/6pm/".$_POST['tempdir']."/".$img_name.".".$img_ext;
